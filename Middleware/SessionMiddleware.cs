...
namespace Cold_Storage_GO.Middleware
{
    public class SessionMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            {
                "/api/Auth/login","/api/Auth/google-login","/api/Auth/register","/api/Auth/request-password-reset","/api/Auth/reset-password","/api/Auth/staff/login", "/swagger", "/api/Account/profile/", "/api/HelpCentre",
